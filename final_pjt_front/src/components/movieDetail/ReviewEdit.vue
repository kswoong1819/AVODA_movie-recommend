            ...
            <div class="modal-dialog" style="max-width:750px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" v-html="`리뷰 수정`"></h5>                        
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            ...
                            <button @click="EditReview(review.id)" type="submit" class="btn btn-dark" data-dismiss="modal">작성</button>
                        </div>
                        <!-- <form>            
                            <p>평점: 
                                <input type="Integer" v-model="reviewData.rank">                
                            </p>
                            <div class="form-group">
                                <label for="content">내용</label>
                                <textarea v-model="reviewData.content" class="form-control" placeholder="리뷰을 작성하세요." id="content" rows="3"></textarea>
                            </div>        
                            <button @click="EditReview(review.id)" type="submit" class="btn btn-primary" data-dismiss="modal">리뷰 수정</button>    
                        </form>       -->
...
export default {
    ...
    methods: {
        EditReview(review_id) {
            ...
            axios.put(SERVER_URL+'/movies/'+this.movie_id+'/review/'+review_id+'/', this.reviewData, this.config)
                .then(() => {                    
