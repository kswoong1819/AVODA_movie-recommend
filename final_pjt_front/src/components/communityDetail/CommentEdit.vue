            ...
            <div class="modal-dialog" style="max-width:750px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" v-html="`댓글 수정`"></h5>                        
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            ...
                            <button @click="EditComment(comment.id)" type="submit" class="btn btn-dark" data-dismiss="modal">댓글 수정</button>
                        </div>                                                                      
                    </div>
...
export default {
    ...
    methods: {
        EditComment(comment_id) {
            ...
            axios.put(SERVER_URL+'/articles/'+this.article_id+'/comment/'+comment_id+'/', this.commentData, this.config)
                .then(() => {                    
